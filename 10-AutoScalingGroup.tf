...
# Auto Scaling Policy
resource "aws_autoscaling_policy" "salsaSunday_scaling_policy" {
...
resource "aws_autoscaling_attachment" "salsaSunday_asg_attachment" {
  autoscaling_group_name = aws_autoscaling_group.salsaSunday-ASG-80.name
  alb_target_group_arn   = aws_lb_target_group.salsaSunday-TG01-80.arn
}
